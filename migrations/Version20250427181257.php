 ...
 */
final class Version20250427181257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, numero VARCHAR(255) NOT NULL, date_commande DATE NOT NULL, etat VARCHAR(70) NOT NULL, mode_paiement VARCHAR(70) NOT NULL, etat_paiement TINYINT(1) NOT NULL, INDEX IDX_6EEAA67DFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
